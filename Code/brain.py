...
NC_PATH = ROOT_DIR / "Data" / "by_grid" / GRID_RESOLUTION / "netcdf" / "PaleoDust_all.nc"

MAIN_DIR = ROOT_DIR / "Data" / "main"
MAIN_HOL_PATH = MAIN_DIR / "main_HOL.txt"
MAIN_LGM_PATH = MAIN_DIR / "main_LGM.txt"
FIGURES_OUT_DIR = ROOT_DIR / "Figures" / GRID_RESOLUTION / "generated"
...
def main():
    ...
    for periodo, subds in periodos.items():
        ...
        graficar_mapa(
            ...
            carpeta_salida=FIGURES_OUT_DIR,
        )
