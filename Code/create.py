...
GRID_RESOLUTION = os.environ.get("GRID_RESOLUTION", "1degree")
GRID_DIR = ROOT_DIR / "Data" / "by_grid" / GRID_RESOLUTION
DATA_DIR = GRID_DIR / "csv"
OUTPUT_DIR = GRID_DIR / "netcdf"
...
def main() -> None:
    ...
    save_individual_files(grouped_files, OUTPUT_DIR)

    if CREATE_COMBINED_FILE:
        save_combined_file(grouped_files, OUTPUT_DIR, COMBINED_FILENAME)
